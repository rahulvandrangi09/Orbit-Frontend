    ...
    <>
      ...
      <div className="auth-page">
        <div className="auth-container reveal show">
          ...
          <h1 className="auth-title">{step === 1 ? "Signup" : "Verify Email"}</h1>
          ...
          {step === 2 && (
            <form onSubmit={handleOtpSubmit} className="auth-form">
              <p style={{ textAlign: "center", marginBottom: "20px", color: "#a1a1aa" }}>
                We've sent a 6-digit transmission code to <strong>{formData.email}</strong>. It will expire in 5 minutes.
              </p>
              ...
              <p className="auth-switch" style={{ marginTop: "15px", cursor: "pointer" }} onClick={() => setStep(1)}>
                Wrong email? Go back.
              </p>
            </form>
          )}
